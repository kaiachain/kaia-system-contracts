    ...
    SystemCallable
{
    ...
    /// @notice Minimum KAIA balance required for nodeId address to enter CandReady state (10 KAIA)
    ...
    uint8 internal constant UINT_CFG_PAUSE_TIMEOUT = 0;
    uint8 internal constant UINT_CFG_IDLE_TIMEOUT = 1;
    uint8 internal constant UINT_CFG_PFS_THRESHOLD = 2;
    uint8 internal constant UINT_CFG_CFS_THRESHOLD = 3;
    uint8 internal constant UINT_CFG_MAX_NODE_COUNT = 4;
    uint8 internal constant UINT_CFG_MAX_VAL_ACTIVE_PAUSED = 5;
    uint8 internal constant UINT_CFG_MAX_CAND_READY = 6;

    // AddressConfigUpdated(configId, ...) IDs
    uint8 internal constant ADDR_CFG_KEF = 0;
    uint8 internal constant ADDR_CFG_KIF = 1;
    uint8 internal constant ADDR_CFG_KPF = 2;
    uint8 internal constant ADDR_CFG_SUSPENDER = 3;
    uint8 internal constant ADDR_CFG_CONFIGURATOR = 4;
    ...
    function _onlySuspender() private view {
    ...
    function _isNodeOverMinStake(address nodeId) internal view returns (bool) {
        address payable stakingContract = payable(_getStorage().nodeInfo[nodeId].stakingContract);
