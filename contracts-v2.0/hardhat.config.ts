...
const config: HardhatUserConfig = {
  solidity: {
    compilers: [
      {
        version: "0.4.24", // CnStakingContract
        settings: { optimizer: { enabled: true, runs: 200 } },
      },
      {
        version: "0.5.16", // WKAIA
        settings: { optimizer: { enabled: true, runs: 999999 } },
      },
      {
        version: "0.6.6", // Uniswap V2
        settings: { optimizer: { enabled: true, runs: 200 } },
      },
      {
        version: "0.8.19", // MultiCallContract
        settings: { optimizer: { enabled: true, runs: 200 } },
      },
      {
        version: "0.8.24", // Gasless
        settings: { optimizer: { enabled: true, runs: 1000 }, viaIR: true },
      },
      {
        version: "0.8.25", // StakingTrackerV2, CLRegistry
        settings: { optimizer: { enabled: true, runs: 200 } },
      },
      {
        version: "0.8.28", // EIP2537
        settings: { optimizer: { enabled: true, runs: 200 } },
      },
    ],
  },
