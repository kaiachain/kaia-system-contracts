...
contract MultiCallContract {
    ...
    function multiCallDPStakingInfo()
        external
        view
        returns (address[] memory nodeIds, address[] memory clPools, uint256[] memory stakingAmounts)
    {
    ...
    function multiCallGaslessInfo() external view returns (address gsr, address[] memory tokens) {
