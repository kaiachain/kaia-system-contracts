...
import { StakingTrackerV2, CnStakingV2, CnStakingContract } from "../../../typechain-types";
import { loadFixture, setBalance } from "@nomicfoundation/hardhat-network-helpers";
import { setRegistryOwner, specialContractsFixture } from "../../../helpers/utils";
...
export async function stakingTrackerV2TestFixture() {
  ...
  return {
    ...ret,
    stakingTracker: ret.stakingTracker as unknown as StakingTrackerV2,
    registry,
  };
}
