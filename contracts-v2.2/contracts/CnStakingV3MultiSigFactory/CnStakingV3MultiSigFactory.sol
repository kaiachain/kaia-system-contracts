...
import {ICnStakingV3MultiSigChunk} from "./interfaces/ICnStakingV3MultiSigChunk.sol";
import {ICnStakingV3MultiSigFactory} from "./interfaces/ICnStakingV3MultiSigFactory.sol";
...
contract CnStakingV3MultiSigFactory is ICnStakingV3MultiSigFactory {
    bytes32 public constant CNSTAKINGV3_MULTISIG_BYTECODE_HASH =
        0x25aa0a2eeac32488de670b651cce642fb18148a5e098930cb5f96c5e833b52ed;
    ...
    function deployCnStakingV3MultiSig(
        ...
        bytes32 salt = keccak256(abi.encode(msg.sender, constructorArgs));
