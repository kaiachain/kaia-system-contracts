...
import {AddressBookBumped} from "../../../contracts/mock/AddressBookBumped.sol";
import {ERC1967Proxy} from "@openzeppelin/contracts/proxy/ERC1967/ERC1967Proxy.sol";
import {IValidatorManager, ValidatorManager} from "../../../contracts/ValidatorManager.sol";
import {CnStakingV3MultiSigFactory} from "../../../contracts/CnStakingV3MultiSigFactory/CnStakingV3MultiSigFactory.sol";
import {CnStakingV3MultiSigChunk1} from "../../../contracts/CnStakingV3MultiSigFactory/CnStakingV3MultiSigChunk1.sol";
import {CnStakingV3MultiSigChunk2} from "../../../contracts/CnStakingV3MultiSigFactory/CnStakingV3MultiSigChunk2.sol";
import {PublicDelegationFactoryV2, IPublicDelegation} from "../../../contracts/PublicDelegationFactoryV2.sol";
import {CnStakingV3MultiSig, ICnStakingV3MultiSig} from "@kaiachain/system-contracts-v1.0/contracts/CnStakingV3/CnStakingV3MultiSig.sol";
import {ICnStakingV3} from "@kaiachain/system-contracts-v1.0/contracts/CnStakingV3/interfaces/ICnStakingV3.sol";
import {CnStakingV2, ICnStakingV2} from "@kaiachain/system-contracts-klaytn-v1.10/contracts/CnStakingV2.sol";
import {IKIP113} from "@kaiachain/system-contracts-klaytn-v1.12/contracts/interfaces/IKIP113.sol";
import {Registry} from "@kaiachain/system-contracts-klaytn-v1.12/contracts/Registry.sol";
import {MockPoC} from "../../../contracts/mock/MockPoC.sol";
import {StakingTrackerMockReceiver} from "../../../contracts/mock/StakingTrackerMockReceiver.sol";
import {MockSimpleBlsRegistry} from "../../../contracts/mock/MockSimpleBlsRegistry.sol";
...
contract BaseTest is Test {
    ...
    MockSimpleBlsRegistry simpleBlsRegistry;
    ...
    function _deploySimpleBlsRegistry(address owner, TestNode[] memory initialNodes) public {
        simpleBlsRegistry = new MockSimpleBlsRegistry(owner);
        vm.startPrank(owner);
        for (uint256 i = 0; i < initialNodes.length; i++) {
