...
const config: HardhatUserConfig = {
  solidity: {
    compilers: [
      {
        version: "0.4.24", // AddressBookMock, CypressCreditV2
        settings: { optimizer: { enabled: true, runs: 200 } },
      },
      {
        version: "0.8.19", // TreasuryRebalanceV2
        settings: { optimizer: { enabled: true, runs: 200 } },
      },
      {
        version: "0.8.24", // Kaiabridge
        settings: { optimizer: { enabled: true, runs: 10000 }, viaIR: true },
      },
      {
        version: "0.8.25", // CnStakingV3, PublicDelegation, Delegator, Lockup, Airdrop
        settings: { optimizer: { enabled: true, runs: 200 } },
      },
    ],
  },
